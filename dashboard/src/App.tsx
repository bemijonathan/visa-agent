...
function LoginPage() {
  const { signInWithGoogle, signInWithEmail, createAccount, loading, isEmulatorMode } = useAuth()
      ...
      <div className="relative z-10 w-full max-w-md px-6">
        ...
        <div className="p-8 rounded-2xl bg-white/[0.03] border border-white/10 backdrop-blur-xl">
          ...
          {isEmulatorMode && (
            <>
              <div className="mb-4 p-3 bg-amber-500/10 border border-amber-500/20 rounded-lg text-amber-400 text-xs">
                Emulator Mode - Use email/password to sign in
              </div>
              ...
              <button
                ...
                className="w-full text-sm text-white/50 hover:text-white transition-colors mb-4"
              >
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 px-6 py-3 bg-white/5 border border-white/10 rounded-xl text-white font-medium hover:bg-white/10 transition-colors disabled:opacity-50"
          >
